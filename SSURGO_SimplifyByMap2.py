...
# 2018-09-18 Revert back to coverage to see if the survey boundary cleaner.
#
## ===================================================================================
...
def ProcessSurvey(outputGDB, outputFDS, surveyBoundaryLayer, soilLayer, areasym, method, simpleTol, sToday, csName, outputFCName):
    ...
    try:
        # Diagnostic settings
        bCov = False       # flag to use FeatureToCoverage_conversion for polylines
        ...
        if bndPolyCnt > 1:
            PrintMsg("\tBoundary lines form " + str(testCnt) + " polygons", 1)
        ...
        # if bndCnt == 0:
            ...
            PrintMsg("\tIdentified small polygons (" + Number_Format(len(elimList), 0, True) + ") for elimination", 1)
